...
valrec relexpr(struct LOC_exec *LINK)
{
  ...
  while (LINK->Token != NULL && LINK->Token->kind < 32 && ((1L << (LINK->Token->kind)) & ((1L << ((long)tokne + 1)) - (1L << ((long)tokeq)))) != 0)
  {
    ...
    if (n.IsStringVal)
    {
      f = ((!strcmp(n.sval, n2.sval) && (unsigned long)k < 32 && ((1L << ((long)k)) & ((1L << ((long)tokeq)) | (1L << ((long)tokge)) | (1L << ((long)tokle)))) != 0) || (strcmp(n.sval, n2.sval) < 0 && (unsigned long)k < 32 && ((1L << ((long)k)) & ((1L << (
(long)toklt)) | (1L << ((long)tokle)) | (1L << ((long)tokne)))) != 0) || (strcmp(n.sval, n2.sval) > 0 && (unsigned long)k < 32 && ((1L << ((long)k)) & ((1L << ((long)tokgt)) | (1L << ((long)tokge)) | (1L << ((long)tokne)))) != 0));
      free(n.sval);
      free(n2.sval);
    }
    else
    {
      f = ((n.val == n2.val && (unsigned long)k < 32 && ((1L << ((long)k)) & ((1L << ((long)tokeq)) | (1L << ((long)tokge)) | (1L << ((long)tokle)))) != 0) || (n.val < n2.val && (unsigned long)k < 32 && ((1L << ((long)k)) & ((1L << ((long)toklt)) | (1L <<
 ((long)tokle)) | (1L << ((long)tokne)))) != 0) || (n.val > n2.val && (unsigned long)k < 32 && ((1L << ((long)k)) & ((1L << ((long)tokgt)) | (1L << ((long)tokge)) | (1L << ((long)tokne)))) != 0));
    }
    n.IsStringVal = FALSE;
    n.val = f;
  }
